...
rec {
  makeSimpleBinWriter =
    ...
    nameOrPath: content:
      assert lib.or (lib.types.path.check nameOrPath) (builtins.match "([0-9A-Za-z._])[0-9A-Za-z._-]*" nameOrPath != null);
